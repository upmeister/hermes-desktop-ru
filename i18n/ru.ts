...
export const ru = defineLocale({
  ...
  notifications: {
    ...
    native: 'Требуется подтверждение',
  ...
  starmap: {
    ...
    emptyDesc:
      'Когда Hermes создаёт навыки и память для вашей работы, они появляются здесь.',
    share: 'Поделиться картой',
    shareHint:
      'Скопируйте код чтобы поделиться картой, или вставьте чтобы загрузить чужую. Только раскладка, не содержимое памяти или навыков.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      revertConfirm:
        'Отменить изменения в этом файле и вернуть к закоммиченному состоянию? Отмена необратима.',
      revertAllConfirm:
        'Отменить все изменения и вернуть файлы к закоммиченному состоянию? Отмена необратима.',
      ...
      agentShipPrompt:
        'Просмотри изменения, закоммить с понятным conventional-commit сообщением, запушь ветку и открой pull request.',
  ...
  updates: {
    ...
    applyStatus: 'Обновление бэкенда не удалось.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      starmap: 'Граф памяти',
    approvalMode: mode => `Режим подтверждения: ${mode}`,
  ...
  desktop: {
    ...
    branchTitle: 'Ветвь',
    handoff: error => `Передача не удалась: ${error}`,
