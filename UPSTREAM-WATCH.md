...
- Релиз **v1.0.4**: EXPECTED_COMMIT → `987064caa4f`; переведён `sendDiagnostics` (фича апстрима).
- Запись 02:05 выше устарела по строке «мод на 14c59f0b505» — актуальный базлайн `987064caa4f`.
